                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <a href="<?= \yii\helpers\Url::to(['organizat/index']) ?>">ОРГАНИЗАЦИИ</a>
                            </li>
                            <li>
                                <a href="<?= \yii\helpers\Url::to(['maps/index']) ?>">ОТМЕТКА НА КАРТЕ</a>
                            </li>
                            <li>
                                <a href="<?= \yii\helpers\Url::to(['comments/index']) ?>">КОММЕНТАРИИ</a>
                            </li>
                        </ul>
                    </div>
            </nav>
